...
class ScrapeResult:
    ...
    def __post_init__(self):
        ...
        if self.successful_items == 0 and self.failed_items == 0:
            self.successful_items = sum(1 for item in self.items if item.is_successful())
...
class ScrapingTemplate:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "list_page_rules": self.list_page_rules.to_dict() if self.list_page_rules else {},
            "detail_page_rules": self.detail_page_rules.to_dict() if self.detail_page_rules else {},
    ...
    def from_dict(cls, data: dict) -> 'ScrapingTemplate':
        ...
        if data.get('list_page_rules'):
            ...
            if 'load_strategy' in rules_data:
                rules_data['load_strategy'] = LoadStrategyConfig.from_dict(rules_data['load_strategy'])
